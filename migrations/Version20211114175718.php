 ...
 */
final class Version20211114175718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, email, roles, password_change_date, enabled, confiramtion_token FROM user');
        ...
        , password_change_date INTEGER DEFAULT NULL, confiramtion_token VARCHAR(40) DEFAULT NULL COLLATE BINARY, enabled BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, roles, password_change_date, enabled, confiramtion_token) SELECT id, username, password, name, email, roles, password_change_date, enabled, confiramtion_token FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        , password_change_date INTEGER DEFAULT NULL, confiramtion_token VARCHAR(40) DEFAULT NULL, enabled BOOLEAN DEFAULT \'FALSE\' NOT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, email, roles, password_change_date, enabled, confiramtion_token) SELECT id, username, password, name, email, roles, password_change_date, enabled, confiramtion_token FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}
